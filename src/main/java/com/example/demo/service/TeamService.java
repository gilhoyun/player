...
public class TeamService {
	...
	public void writeMatching(int hostTeamId, int createdBy, String matchDate, String region, String stadium, String formattedPlayerCount, String gender, String description) {
	    teamDao.writeMatching(hostTeamId, createdBy, matchDate, region, stadium, formattedPlayerCount, gender, description);
	}
