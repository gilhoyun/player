...
<section>
   <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
     ...
     <c:if test="${rq.getLoginedMemberId() != -1}">
       <form action="/usr/teamReply/doWrite" method="post" onsubmit="teamReplyForm_onSubmit(this); return false;">
         <input name="relTypeCode" type="hidden" value="team" /> 
         <input name="relId" type="hidden" value="${team.id}" />
         <div class="table-box">
           <table class="w-full text-left border-collapse">
             <thead>
               <tr>
