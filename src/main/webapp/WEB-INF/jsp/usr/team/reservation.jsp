			...
			<c:when test="${not empty reservations}">
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
					<c:forEach var="reservation" items="${reservations}">
						<div class="card w-full bg-white shadow-xl rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
							...
							<div class="card-body p-6 text-center">
								...
								<!-- Information block with vertical layout -->
								<div class="text-left mb-4">
									<p class="text-sm text-gray-600 mb-2">
										<i class="fa-solid fa-head-side-virus"></i> <strong>이용 대상 :</strong> ${reservation.useTgtInfo}
									</p>
									<p class="text-sm text-gray-600 mb-2">
										<i class="fa-solid fa-calendar-check"></i> <strong>접수 시작 :</strong> ${reservation.startDate.substring(2,16)}
									</p>
									<p class="text-sm text-gray-600 mb-2">
										<i class="fa-solid fa-calendar-check"></i> <strong>접수 종료 :</strong> ${reservation.endDate.substring(2,16)}
									</p>
									<p class="text-sm text-gray-600 mb-4">
										<i class="fa-solid fa-hourglass-half"></i> <strong>이용 시간 :</strong> ${reservation.startTime} - ${reservation.endTime}
									</p>
								</div>
				...
				<div class="mt-5 flex justify-between items-center">
					<div class="flex-grow flex justify-center">
						<div class="join">
							<c:set var="path" value="?boardId=${board.id}&searchType=${searchType}&searchKeyword=${searchKeyword}" />
							...
							<c:forEach var="i" begin="${fromPage}" end="${toPage}">
								<a href="${path}&page=${i}" class="join-item btn btn-square ${page == i ? 'btn-active' : ''}">
									${i}
								</a>
							</c:forEach>
